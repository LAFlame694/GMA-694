...
class User:
   ...
   def init_ui(self):
       ...
       self.main_frame = self.ui.creat_frame(self.mainWindow, 0, 80, 1200, 620, '#000000')


       self.invoice_list_frame = self.ui.creat_frame(self.main_frame, 0, 0, 550, 620, '#8000FF')
       self.invoice_list_label = self.ui.creat_label(self.invoice_list_frame, 'Invoices', 0, 10,550, 30, '#FF0080', '#000000', 10)

       self.invoice_detail_frame = self.ui.creat_frame(self.main_frame, 650, 0, 550, 380, '#8000FF')
       ...
       self.actions_payments_frame = self.ui.creat_frame(self.main_frame, 650, 380, 550, 240, '#8000FF')
       ...
       self.total_label = self.ui.create_label_pack(self.balance_summery, f'Total: 7000', bg='#FF0080', fg='#000000', font=("Comic Sans MS", 10, "bold"), anchor='w')
       self.paid_label = self.ui.create_label_pack(self.balance_summery, f'Paid: 3000', bg='#FF0080', fg='#000000', font=("Comic Sans MS", 10, "bold"), anchor='w')
       self.balance_label = self.ui.create_label_pack(self.balance_summery, f'Balance: 4000', bg='#FF0080', fg='#000000', font=("Comic Sans MS", 10, "bold"), anchor='w')
